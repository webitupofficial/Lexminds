...
export const INITIAL_INTERNSHIPS: Internship[] = [
  {
    ...
    organization: 'Lex Minds Editorial & Research Wing',
    orgType: 'Legal Education & Research',
    practiceArea: 'Criminal & Constitutional Law',
    location: 'Remote (Pan-India)',
    mode: 'Remote',
    duration: '8 Weeks',
    stipend: 'Unpaid (Academic Learning Fellowship)',
    applicationFee: 39,
    seats: 5,
    deadline: '2026-10-15',
    featured: true,
    ...
    responsibilities: [
      ...
      'Author high-impact legal commentary and case briefs for publication in the Lex Minds Law Review.',
    ...
    learningOutcomes: [
      ...
      'Verifiable Certificate of Completion with authenticated credentials upon fulfilling milestone requirements.',

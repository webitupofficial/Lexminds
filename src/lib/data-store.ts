...
export const INITIAL_INTERNSHIPS: Internship[] = [
  {
    id: 'int-1',
    slug: 'september-two-week-legal-media-internship',
    title: 'September Two-Week Legal Media Internship',
    organization: 'Lex Minds India',
    orgType: 'Legal Education & Research',
    practiceArea: 'Legal Media & Content Creation',
    location: 'Online',
    mode: 'Online',
    duration: '2 Weeks',
    stipend: 'Internship Certificate & Practical Mentorship',
    applicationFee: 59,
    lateFee: 20,
    seats: 50,
    deadline: '2026-09-30',
    ...
    responsibilities: [
      ...
      'Basics of legal media and communication',
      'Presenting legal topics in a simple and engaging manner',
      'Practical exposure to legal content creation',
    ],
    eligibility: [
      'Law students and students interested in legal media',
      'Interest in law, legal content creation, and digital media',
      'Commitment to participate actively during the 2-week September 2026 cohort',
    ],
    learningOutcomes: [
      'Internship Certificate upon successful completion',
      'Practical experience in legal media',
      'Opportunity to develop legal communication and content-creation skills',
      'Guidance and mentorship during the internship',
    ],
    selectionProcess: [
      'Stage 1: Online Registration & Profile details submission',
      'Stage 2: Registration fee confirmation (₹59: ₹39 standard + ₹20 late fee)',
      'Stage 3: Cohort onboarding, orientation briefing & module allocation',
    ],
...
The DPDP Act transforms corporate privacy from a tick-box legal exercise into a board-level fiduciary discipline. Indian enterprises must prioritize data mapping, automated consent revocation pipelines, and vendor risk assessments before the enforcement rules are formally gazetted.`,
    ...
    status: 'published',
    citationFormat: {
      bluebook: 'Ishaan Sen, Architecting Compliance Under India’s DPDP Act 2023, 4 LEX MINDS L. REV. 112 (2026).',
      oscola: 'Ishaan Sen, ‘Architecting Compliance Under India’s DPDP Act 2023’ (2026) 4 Lex Minds Law Review 112.',
...
Section 124A (Sedition) of the old IPC has been replaced by Section 152 of the BNS, which punishes acts endangering the sovereignty, unity, and integrity of India with stringent mens rea requirements.`,
    ...
    status: 'published',
    citationFormat: {
      bluebook: 'Ananya Mukherjee, Decolonizing the Penal Code: Analyzing the Bharatiya Nyaya Sanhita, 4 LEX MINDS L. REV. 145 (2026).',
      oscola: 'Ananya Mukherjee, ‘Decolonizing the Penal Code: Analyzing the Bharatiya Nyaya Sanhita’ (2026) 4 Lex Minds Law Review 145.',
...
Commercial machine learning training datasets do **not** neatly qualify as private research or review. Therefore, without a legislative Text and Data Mining (TDM) exception, commercial LLM scraping without licensing creates prima facie copyright infringement exposure under Section 51.`,
    ...
    status: 'published',
    citationFormat: {
      bluebook: 'Rohan Vashisht, Generative AI and Copyright Infringement Under Indian Law, 4 LEX MINDS L. REV. 180 (2026).',
      oscola: 'Rohan Vashisht, ‘Generative AI and Copyright Infringement Under Indian Law’ (2026) 4 Lex Minds Law Review 180.',
...
- Gross Merchandise Value (GMV) from Indian transactions exceeds ₹500 Crore.`,
    ...
    status: 'published',
    citationFormat: {
      bluebook: 'Kavita Menon, The Deal Value Threshold Paradigm in Indian Antitrust, 4 LEX MINDS L. REV. 205 (2026).',
      oscola: 'Kavita Menon, ‘The Deal Value Threshold Paradigm in Indian Antitrust’ (2026) 4 Lex Minds Law Review 205.',

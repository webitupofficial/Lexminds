  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-8 sm:space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-start">
        ...
        <div className="lg:col-span-7 editorial-card rounded-sm p-4 sm:p-6 space-y-4 bg-white dark:bg-ink-850 border border-ink-200 dark:border-ink-800">
          
          <div className="flex items-center justify-between px-2 pt-1 border-b border-ink-200 dark:border-ink-800 pb-3">
            <h2 className="text-base sm:text-lg font-serif font-bold text-ink-950 dark:text-white flex items-center space-x-2">
              <Mail className="w-4 h-4 text-oxblood-700 dark:text-oxblood-400" />
            ...
            <a 
              ...
              className="text-[11px] font-mono text-ink-500 hover:text-oxblood-700 dark:text-ink-400 dark:hover:text-oxblood-400 flex items-center space-x-1"
            >
          ...
          <div className="relative w-full rounded-sm overflow-hidden border border-ink-200 dark:border-ink-800 bg-white shadow-sm min-h-[950px]">
            {iframeLoading && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-ivory-50 dark:bg-ink-900 text-ink-500 text-xs space-y-2 z-10">
                <Loader2 className="w-5 h-5 animate-spin text-oxblood-700" />
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="editorial-card rounded-sm p-6 space-y-4 text-xs bg-white dark:bg-ink-850 border border-ink-200 dark:border-ink-800">
            <h3 className="text-base font-serif font-bold text-ink-950 dark:text-white flex items-center space-x-2">
              <Building className="w-4 h-4 text-oxblood-700 dark:text-oxblood-400" />
              <span>Secretariat &amp; Communications</span>
            </h3>

            <div className="space-y-3 text-ink-600 dark:text-ink-300">
              <div className="flex items-start space-x-2.5">
                <MapPin className="w-4 h-4 text-oxblood-700 dark:text-oxblood-400 shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink-950 dark:text-white block font-mono text-[11px] uppercase">Secretariat:</strong>
                  <span>Digital Editorial Secretariat &bull; Online Operations (Pan-India)</span>
                </div>
              </div>

              <div className="flex items-start space-x-2.5">
                <Mail className="w-4 h-4 text-oxblood-700 dark:text-oxblood-400 shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink-950 dark:text-white block font-mono text-[11px] uppercase">Electronic Desks:</strong>
                  <span className="block font-mono text-[11px]">editorial@lexminds.in (Treatises &amp; Law Review)</span>
          ...
          <div className="editorial-card rounded-sm p-6 space-y-3 text-xs text-ink-600 dark:text-ink-300 bg-white dark:bg-ink-850 border border-ink-200 dark:border-ink-800">
            <h4 className="font-serif font-bold text-ink-950 dark:text-white flex items-center space-x-2 text-sm">
              <Shield className="w-4 h-4 text-oxblood-700 dark:text-oxblood-400" />
            ...
            <div className="p-3 bg-ivory-50 dark:bg-ink-900 rounded-sm border border-ink-200 dark:border-ink-800 space-y-1 text-[11px] font-mono">
              <div className="font-semibold text-oxblood-700 dark:text-oxblood-400">Editorial Council &bull; Academic Oversight</div>
              <div className="text-ink-500">Email: editorial@lexminds.in</div>
            </div>
          </div>

          {/* Response Standards */}
          <div className="p-4 rounded-sm bg-ivory-100 dark:bg-ink-900 border border-ink-200 dark:border-ink-800 text-xs space-y-1.5">
            <span className="font-serif font-bold text-ink-950 dark:text-white text-xs block">
              Response Standards
            </span>
      ...
      <div className="editorial-card rounded-sm p-6 sm:p-8 space-y-6 bg-white dark:bg-ink-850 border border-ink-200 dark:border-ink-800">
        <div className="border-b border-ink-200 dark:border-ink-800 pb-3">
          ...
          <h2 className="text-2xl font-serif font-bold text-ink-950 dark:text-white mt-1">
        ...
        <div className="space-y-2.5">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div
                key={idx}
                className="rounded-sm bg-ivory-50 dark:bg-ink-900 border border-ink-200 dark:border-ink-800 overflow-hidden transition-all"
              >
                <button
                  onClick={() => setOpenFaq(isOpen ? null : idx)}
                  className="w-full p-4 sm:p-4.5 text-left flex items-center justify-between text-xs sm:text-sm font-serif font-bold text-ink-950 dark:text-white hover:text-oxblood-700 dark:hover:text-oxblood-400 transition-colors"
                >
                  <span>{faq.q}</span>
                  {isOpen ? (
                    <ChevronUp className="w-4 h-4 text-oxblood-700 dark:text-oxblood-400 shrink-0 ml-2" />
                  ) : (
                    <ChevronDown className="w-4 h-4 text-ink-400 shrink-0 ml-2" />
                  )}
                </button>
                {isOpen && (
                  <div className="px-4 pb-4 text-xs text-ink-600 dark:text-ink-300 leading-relaxed border-t border-ink-100 dark:border-ink-800 pt-3 font-normal">
                    {faq.a}
                  </div>
                )}
              </div>

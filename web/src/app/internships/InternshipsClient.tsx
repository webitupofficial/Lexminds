      ...
      <div className="space-y-6">
        ...
        <div className="border-b border-ink-900/15 dark:border-ink-700 pb-8 space-y-3">
          ...
          <h1 className="text-4xl sm:text-5xl font-serif font-bold text-ink-950 dark:text-ink-50 tracking-tight">
            Legal Internship Programmes in India
          </h1>
            ...
            return (
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
                  ...
                  {isItemClosed ? (
                    <span className="text-rose-600 dark:text-rose-400 font-bold text-xs uppercase tracking-wider">
                ...
                <div className="pt-6 border-t border-ink-900/10 dark:border-ink-800 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                  ...
                  <Link
                    ...
                    className={`px-6 py-3.5 text-xs font-semibold uppercase tracking-wider text-center self-start sm:self-auto flex items-center space-x-2 rounded-sm ${
                      isItemClosed
                  ...
                  >
                    <span>{isItemClosed ? 'View Details (Closed)' : 'View Details & Register'}</span>

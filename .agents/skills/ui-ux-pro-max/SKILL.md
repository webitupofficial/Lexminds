...
The search script lives inside this skill's directory (`.agents/skills/ui-ux-pro-max/scripts/`). It supports both Node.js (`search.mjs`) and Python (`search.py`):

```bash
# Using Node.js (recommended, zero-dependency)
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "<query>" --domain <domain>

# Using Python (if python 3.x is available)
...
```bash
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "<keyword>" --stack <stack>
```
...
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "keyboard focus modal" --domain ux

# Step 4: stack guidelines
node .agents/skills/ui-ux-pro-max/scripts/search.mjs "suspense streaming bundle" --stack nextjs
```
